...
<html>
<body>
<form name="API.GetRechargeHistory" id="API.GetRechargeHistory" enctype="multipart/form-data" method="post" action="JSON.GetRechargeHistory.php" accept-charset="utf-8">	
	<table>
