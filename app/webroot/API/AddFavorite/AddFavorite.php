...
<html>
<body>
<form name="API.AddFavorite" id="API.AddFavorite" enctype="multipart/form-data" method="post" action="JSON.AddFavorite.php" accept-charset="utf-8">	
	<table>
		<TR><TD>Name</TD><TD><input name="Name" type="text"></TD></TR>
		<TR><TD>Phone Number</TD><TD><input name="Phone_Number" type="number"></TD></TR>
