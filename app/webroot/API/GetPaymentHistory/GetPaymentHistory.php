...
<html>
<body>
<form name="API.GetPaymentHistory" id="API.GetPaymentHistory" enctype="multipart/form-data" method="post" action="JSON.GetPaymentHistory.php" accept-charset="utf-8">	
	<table>
