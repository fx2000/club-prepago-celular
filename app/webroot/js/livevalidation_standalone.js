...
var Validate = {
   ...
   value= trim(value);
    	...
    	var message = paramsObj.failureMessage || "Error";
...
NumberValidFloat: function(value, paramsObj){
    	var paramsObj = paramsObj || {};
    	var message = paramsObj.failureMessage || "Must be a Number (eg-11 or 11.11) !";
    	Validate.Format(value, { failureMessage: message, pattern: /^[1-9][0-9]{0,2}(?:,?[0-9]{3}){0,3}(?:\.[0-9]{0,2})?$/ } );
    	return true;
    },
...
/^(http|https):\/\/[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(([0-9]{1,5})?\/.*)?$/
	 ...
	 password: function(value, paramsObj){
    	...
    	var message = paramsObj.failureMessage || "Confirm password and new password do not match!";
    	  	Validate.fail(message);
    	}
    	return true; 
    },
