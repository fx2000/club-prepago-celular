...
<table id="mainStructure" width="800" class="full-width" align="center" border="0" cellspacing="0" cellpadding="0" style="background-color: #efefef; width: 800px; max-width: 800px; outline: rgb(239, 239, 239) solid 1px; box-shadow: rgb(224, 224, 224) 0px 0px 5px; margin: 0px auto;"><!--START VIEW ONLINE AND ICON SOCAIL --><tbody><tr><td align="center" valign="top" style="background-color: #f05e5e; " bgcolor="#f05e5e">
        ...
        </tr><!-- END HEIGHT SPACE 20PX--></tbody><!--START IMAGE HEADER LAYOUT--><tbody><tr><td valign="top" style="background-color: #ececec;" bgcolor="#ececec">
            <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" class="full-width" style="background-color: #ececec; margin: 0px auto;"><tbody><tr><td class="full-width" width="100%" align="center" valign="top">
                  ...
                  <table width="600" align="center" border="0" cellspacing="0" cellpadding="0" class="full-width" style="background-color: #ffffff; min-width: 600px; width: 600px; margin: 0px auto;"><tbody><tr><td valign="top" align="center" width="600" style="width: 600px;">
                        <a href="#" style="font-size: inherit; border-style: none; text-decoration: none !important;" border="0">
                          <img class="image-100-percent" src="http://www.clubprepago.com/email/banner.png" width="600" alt="image_header_600x300" style="max-width: 600px; display: block !important; width: 600px; height: auto;" border="0" hspace="0" vspace="0" height="auto"></a>
                      </td>
                    </tr></tbody></table><!-- end header container --></td>
              </tr></tbody></table></td>
        </tr><!--END IMAGE HEADER LAYOUT--></tbody><!-- START LAYOUT 1 --><tbody><tr><td align="center" valign="top" style="background-color: #ececec;" bgcolor="#ececec">
            ...
            <table width="600" align="center" border="0" cellspacing="0" cellpadding="0" class="container" style="background-color: #ffffff; border-bottom: 2px solid rgb(199, 199, 199); min-width: 600px; width: 600px; margin: 0px auto;"><tbody><tr><td valign="top">
                  ...
                  <table width="560" align="center" border="0" cellspacing="0" cellpadding="0" class="full-width" style="width: 560px; margin: 0px auto;"><!--start space height --><tbody><tr><td height="20" style="height: 20px; font-size: 0px; line-height: 0; border-collapse: collapse;">&nbsp;</td>
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" align="left" width="100%" style="mso-table-lspace:0pt; mso-table-rspace:0pt;"><tbody><tr><td style="font-size: 18px; font-family: Arial, Tahoma, Helvetica, sans-serif; color: #555555; font-weight: bold; text-align: center; word-break: break-word; line-height: 26px;" align="center"><span style="color: #555555; line-height: 26px; font-size: 18px; font-weight: bold; font-family: Arial, Tahoma, Helvetica, sans-serif;"><font face="Arial, Tahoma, Helvetica, sans-serif">Lo sentimos <?php echo $username; ?><a href="#" style="color: #555555; text-decoration: none !important; border-style: none; line-height: 26px; font-size: 18px; font-weight: bold; font-family: Arial, Tahoma, Helvetica, sans-serif;" data-mce-href="#" border="0"><font face="Arial, Tahoma, Helvetica, sans-serif"><br style="font-size: 18px; font-weight: bold; font-family: Arial, Tahoma, Helvetica, sans-serif;">Tu pago ha sido&nbsp;<span style="color: #f05e5e; line-height: 26px; font-size: 18px; font-weight: bold; font-family: Arial, Tahoma, Helvetica, sans-serif;"><font face="Arial, Tahoma, Helvetica, sans-serif">Rechazado</font></span></font></a></font></span></td>
                          </tr><!--start space height --><tr><td height="15" style="height: 15px; font-size: 0px; line-height: 0; border-collapse: collapse;"></td>
                          </tr><!--end space height --><tr><td style="font-size: 13px; font-family: Arial, Tahoma, Helvetica, sans-serif; color: #a3a2a2; font-weight: normal; text-align: justify; word-break: break-word; line-height: 21px;" align="justify"><div style="text-align: justify; font-size: 13px; font-weight: 400; font-family: Arial, Tahoma, Helvetica, sans-serif;">Tu pago con número de referencia <span style="line-height: 21px; font-size: 13px; font-weight: bold; font-family: Arial, Tahoma, Helvetica, sans-serif;"><font face="Arial, Tahoma, Helvetica, sans-serif"><?php echo $payment_number; ?></font></span>&nbsp;ha sido rechazado:</div><div style="text-align: justify; font-size: 13px; font-weight: 400; font-family: Arial, Tahoma, Helvetica, sans-serif;"><br style="font-size: 13px; font-weight: 400; font-family: Arial, Tahoma, Helvetica, sans-serif;">Fecha de Notificación: <span style="line-height: 21px; font-size: 13px; font-weight: bold; font-family: Arial, Tahoma, Helvetica, sans-serif;"><font face="Arial, Tahoma, Helvetica, sans-serif"><?php echo $notification_date; ?></font></span><br style="font-size: 13px; font-weight: 400; font-family: Arial, Tahoma, Helvetica, sans-serif;">Fecha de Rechazo:<span style="line-height: 21px; font-size: 13px; font-weight: bold; font-family: Arial, Tahoma, Helvetica, sans-serif;"><font face="Arial, Tahoma, Helvetica, sans-serif">&nbsp;<?php echo $status_change; ?></font></span><br style="font-size: 13px; font-weight: 400; font-family: Arial, Tahoma, Helvetica, sans-serif;">Monto: <span style="line-height: 21px; font-size: 13px; font-weight: bold; font-family: Arial, Tahoma, Helvetica, sans-serif;"><font face="Arial, Tahoma, Helvetica, sans-serif">Bs. &nbsp;<?php echo $amount_total; ?></font></span><br style="font-size: 13px; font-weight: 400; font-family: Arial, Tahoma, Helvetica, sans-serif;">Motivo de Rechazo: <span style="line-height: 21px; font-size: 13px; font-weight: bold; font-family: Arial, Tahoma, Helvetica, sans-serif;"><font face="Arial, Tahoma, Helvetica, sans-serif"><?php echo $denial_reason; ?><br style="font-size: 13px; font-weight: bold; font-family: Arial, Tahoma, Helvetica, sans-serif;"><br style="font-size: 13px; font-weight: bold; font-family: Arial, Tahoma, Helvetica, sans-serif;"></font></span>Por favor vuelve a intentarlo cuando se haya resuelto el inconveniente.</div></td>
                              ...
                              <table width="auto" border="0" align="center" cellpadding="0" cellspacing="0" style="margin: 0px auto;"><tbody><tr><td valign="top" align="center">
                                    <!-- start button -->
                                    <!-- end button --><!-- start button --><!-- end button --></td>
                                </tr></tbody></table></td>
        ...
        </tr><!-- END LAYOUT 1 --></tbody><!-- START LAYOUT 9 --><tbody><tr><td align="center" valign="top" style="background-color: #ececec;" bgcolor="#ececec">
            ...
            <table width="600" align="center" border="0" cellspacing="0" cellpadding="0" class="container" style="background-color: #ffffff; border-bottom: 2px solid rgb(199, 199, 199); min-width: 600px; width: 600px; margin: 0px auto;"><tbody><tr><td valign="top">
                  ...
                  <table width="560" align="center" border="0" cellspacing="0" cellpadding="0" class="full-width" style="width: 560px; margin: 0px auto;"><!--start space height --><tbody><tr><td height="20" style="height: 20px; font-size: 0px; line-height: 0; border-collapse: collapse;">&nbsp;</td>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left" style="mso-table-lspace:0pt; mso-table-rspace:0pt;"><tbody><tr><td align="left" valign="top" width="29" style="padding-right: 10px; width: 29px;">
                            ...
                            <td align="left" style="font-size: 18px; font-family: Arial, Tahoma, Helvetica, sans-serif; color: #555555; font-weight: bold; text-align: left; word-break: break-word; line-height: 26px;"><span style="color: #555555; line-height: 26px; font-size: 18px; font-weight: bold; font-family: Arial, Tahoma, Helvetica, sans-serif;"><font face="Arial, Tahoma, Helvetica, sans-serif"><a href="#" style="color: #555555; text-decoration: none !important; border-style: none; line-height: 26px; font-size: 18px; font-weight: bold; font-family: Arial, Tahoma, Helvetica, sans-serif;" data-mce-href="#" border="0"><font face="Arial, Tahoma, Helvetica, sans-serif"><span style="color: #f05e5e; line-height: 26px; font-size: 18px; font-weight: bold; font-family: Arial, Tahoma, Helvetica, sans-serif;"><font face="Arial, Tahoma, Helvetica, sans-serif">¿Necesitas ayuda?</font></span></font></a></font></span></td>
                          </tr></tbody></table></td>
        ...
        </tr><!-- END LAYOUT-14--></tbody><tbody><tr><td align="center" valign="top" style="background-color:#f05e5e;" bgcolor="#f05e5e">
            <table width="600" align="center" border="0" cellspacing="0" cellpadding="0" class="container" style="background-color: #f05e5e; min-width: 600px; width: 600px; margin: 0px auto;"><tbody><tr><td valign="top">
