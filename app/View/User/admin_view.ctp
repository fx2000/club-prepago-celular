...
// Get Longitude
if (!empty($this->data['User']['x'])) {
	$longitude = $this->data['User']['x'];
} else {
	$longitude = '0.000000';
}

// Get Latitude
if (!empty($this->data['User']['y'])) {
	$latitude = $this->data['User']['y'];
} else {
	$latitude = '0.000000';
}
...
<div class="row-fluid ">
	<div class="box span6">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-list-alt"></i><?php echo __(' View User'); ?></h2>
		</div>
