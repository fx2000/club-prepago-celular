<?php
/**
 * Reseller Purchase History view
 *
 *
 *
 *
...
<div class="row-fluid ">	
	<div class="box span12">
		...
		<div class="box-content">
			<table class="table table-striped table-bordered bootstrap-datatable Respurdatatable">
				<thead>
					<tr>							
				...
				<tbody>
					...
					<tr>
						...
						<td class="hidden-phone"><?php echo $val['Payment']['payment_method'] == 1 ? 'Bank Deposit' : 'Credit card'; ?></td>
						<td align="center" >
							<?php
